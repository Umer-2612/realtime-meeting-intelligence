...
namespace PsiBot.Services.Controllers
{
    ...
    public class PlatformCallController : ControllerBase
    {
        ...
        /// </summary>
        public PlatformCallController(ITeamsCallLifecycleService callLifecycleService, IGraphLogger logger)
        {
            this._callLifecycleService = callLifecycleService;
            this._logger = logger;
        }
        ...
        public async Task<IActionResult> OnIncomingRequestAsync()
        {
            ...
            var response = await _callLifecycleService.Client.ProcessNotificationAsync(ConvertHttpRequestToHttpRequestMessage(this.Request)).ConfigureAwait(false);
