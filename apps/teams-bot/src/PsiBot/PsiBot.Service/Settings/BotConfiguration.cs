...
{
    /// <summary>
    /// Strongly typed configuration values backing bot initialization and media settings.
    /// </summary>
    public class BotConfiguration
    {
        /// <summary>
        /// Friendly name assigned to the bot instance.
        /// </summary>
        /// <value>The name of the bot.</value>
        public string BotName { get; set; }

        /// <summary>
        /// Primary DNS name used to reach the service.
        /// </summary>
        /// <value>The name of the service DNS.</value>
        public string ServiceDnsName { get; set; }

        /// <summary>
        /// Canonical DNS name the service responds to; defaults to <see cref="ServiceDnsName"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes dependent settings including media platform configuration and listening endpoints.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the configured certificate from the machine store by thumbprint.
        /// </summary>
        /// <returns>Installed X509 certificate matching <see cref="CertificateThumbprint"/>.</returns>
        /// <exception cref="Exception">Thrown when the certificate cannot be located.</exception>
