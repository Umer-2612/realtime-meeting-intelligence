...
{
	void (*onHostPrivilegeGranted_)();
	void (*onCoHostPrivilegeGranted_)();

public:
	MeetingParticipantsCtrlEventListener(void (*onHostPrivilegeGranted)(), void (*onCoHostPrivilegeGranted)());
